...
$query = mysqli_query($connection, "INSERT INTO showroom_mobil(nama_mobil, brand_mobil, warna_mobil, tipe_mobil, harga_mobil) VALUES ('$namamobil','$brandmobil','$warnamobil','$tipemobil','$hargamobil')");
